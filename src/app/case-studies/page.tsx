...
export default function CaseStudies() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] flex flex-col">
      ...
      <div className="p-8">
        <h1 className="text-2xl font-bold sora-text">Case Studies</h1>
        <p className="mt-4 sora-light">Explore our innovative AI solutions and their real-world impact.</p>
      </div>
    </div>
  );
} 