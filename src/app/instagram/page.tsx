    ...
    <div className="min-h-screen bg-[#f8f7f2] flex flex-col">
      ...
      <nav className="flex justify-between items-center px-4 md:px-16 py-4 border-b border-gray-200">
        ...
        <div className="flex space-x-6 md:space-x-12 items-center">
          <Link href="/instagram" className="text-sm md:text-base hover:underline font-bold">{t('instagram')}</Link>
          <Link href="/faq" className="text-sm md:text-base hover:underline">{t('faq')}</Link>
      ...
      <div className="p-8">
        <h1 className="text-2xl font-bold">Instagram Page</h1>
      </div>
    </div>
  );
} 