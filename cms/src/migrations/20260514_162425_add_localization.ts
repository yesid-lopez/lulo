...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  -- Backfill existing English content into the new locale tables before dropping columns.
  INSERT INTO "case_studies_locales" ("title", "description", "award_title", "award_event", "_locale", "_parent_id")
    SELECT "title", "description", "award_title", "award_event", 'en'::"_locales", "id"
    FROM "case_studies";
  INSERT INTO "case_studies_key_features_locales" ("title", "description", "_locale", "_parent_id")
    SELECT "title", "description", 'en'::"_locales", "id"
    FROM "case_studies_key_features";
  INSERT INTO "case_studies_tags_locales" ("tag", "_locale", "_parent_id")
    SELECT "tag", 'en'::"_locales", "id"
    FROM "case_studies_tags";
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  -- Restore English content from the locale tables before dropping them.
  UPDATE "case_studies" cs SET
    "title" = csl."title",
